...
public class CharacterController2D : MonoBehaviour
{
    ...
    private bool m_Grounded;          // Radius of the overlap circle to determine if the player can stand up
    ...
    public void Move(Vector2 move, bool crouch, bool jump)
    {
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            if (move_y <= 0)
            {
                move_y = gameObject.GetComponent<Rigidbody2D>().velocity.y;
            }
            else
            {
                move_y = move.y * 10;
            ...
            Vector3 targetVelocity = new Vector2(move.x * 10f, move_y);
